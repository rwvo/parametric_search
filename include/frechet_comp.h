...
#ifndef FRECHET_COMP_H
#define FRECHET_COMP_H

  //--------------------------------------------------
  template< class Traits >
  class Frechet_comp : public Traits::comparison_base_t
  //--------------------------------------------------
  {
  ...
  // constructor is private. A Frechet_comp object can and may only be
  // created by its static member function lazy_create_comparison

    Frechet_comp( process_base_t* parent,
		  bool& comp_result,
		  const polynomial_t& first,
		  const polynomial_t& second );
  ...
  private: // data members
    ...
    number_t squared_root_;

  private: // static data member
    static number_t static_squared_root_;
  };

#endif // FRECHET_COMP_H
